" evplg ([e]xtended [v]im [pl]u[g]in) - common
" main plugin script
...
" inclusion control {{{
if exists( 'g:evplg_common_plugin_loaded' ) || ( exists( 'g:evplg_common_plugin_disable' ) && g:evplg_common_plugin_disable != 0 )
	finish
endif
let g:evplg_common_plugin_loaded = 1
" }}}
...
" internal setup {{{
"? function s:EVPlg_uoprjs_LocalSetup( src ) abort
"? 	let l:success = !0 " true
"? 	return l:success
"? endfunction
"? let s:evplg_common_plugin_local_globalsetup_succeeded = s:EVPlg_uoprjs_LocalSetup( expand( '<sfile>' ) )
